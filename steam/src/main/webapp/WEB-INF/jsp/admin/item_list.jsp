...
<html>
    ...
    <body class="side_menu_active side_menu_expanded">
                        ...
                        <div class="col-md-12">
                        	...
                        	<form id="search_form" action="${pageContext.request.contextPath }/admin/items" method="post">
	                            ...
	                            <div class="row">
	                                ...
	                                <!-- 标签id -->
	                                <!-- name -->
	                                <input type="hidden" id="search_form_item_tagids" name="item_tagids" value="">
	                                
	                                <!-- 平台id -->
	                                <input type="hidden" id="search_form_item_platform" name="item_platform" value="">
	                                
	                                <!-- 排序传值 -->
	                                <!-- name -->
	                                <input type="hidden" id="search_form_sort_name" name="sort_name" value="">
	                                
	                                <!-- rule -->
	                                <input type="hidden" id="search_form_sort_rule" name="sort_rule" value="${itemVo.sort_rule }">
	                                        ...
	                                        <tbody id="item_info_date">
		                                        	<tr>
		                                                ...
		                                                <td>
		                                                	...
		                                                	<a herf="#" id="del_btn" class="btn btn-xs ${item.is_enable==true? 'btn-danger':'btn-warning'}" onclick="deleteItems(${item.item_id},${item.is_enable})">${item.is_enable==true? '下架':'上架'}</a>
		                                                </td>
		                                           	</tr>
	                                        </tbody>
                                        </c:forEach>
                   ...
                   <div class="modal-body">
	                    ...
	                    <form class="form-horizontal" id="add_items_form" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<div>
										...
										<c:forEach items="${platformList }" var="dict_platform">
											<label><input type="checkbox" name="add_platform" value="${dict_platform.dict_id }">${dict_platform.dict_item_name }</label>&nbsp;&nbsp;
										</c:forEach>
                           			</div>
								</div>
							</div>
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-10">
									<div class="input-group date" id="dp_component_add">
                ...
                <div class="modal-dialog modal-content">
                    <div class="modal-content">
                        <div class="modal-header">
                   	  ...
                   	  <div class="modal-body">
                        <!--描述：游戏修改弹出层-->
	                    <form class="form-horizontal" id="edit_items_form" enctype="multipart/form-data" method="post">
	                    	<!-- item_id -->
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<div>
										...
										<c:forEach items="${platformList }" var="dict_platform">
											<label><input type="checkbox" name="edit_platform" value="${dict_platform.dict_id }">${dict_platform.dict_item_name }</label>&nbsp;&nbsp;
										</c:forEach>
                           			</div>
								</div>
							</div>
                            ...
                            <!-- 发售日期 -->	
                      		<div class="form-group">
								...
								<div class="col-sm-10">
									<div class="input-group date" id="dp_component_edit">
                ...
                <div class="modal-dialog modal-content">
                    <div class="modal-content">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									...
									<input type="hidden" id="search_item_platform" value="">
										<c:forEach items="${platformList }" var="dict_platform">
											<label><input type="checkbox" name="search_platform" value="${dict_platform.dict_id }">${dict_platform.dict_item_name }</label>&nbsp;&nbsp;
										</c:forEach>
                           			</div>
								</div>
							</div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary btn-sm" onclick="setTagidsAndPlatformToForm()">确认选择</button>
                        </div>
                    </div>
                </div>
        ...
        $(function() {
            ...
            //datepicker
            yukon_datepicker.p_forms_extended("_add");
            yukon_datepicker.p_forms_extended("_edit");
            init();
		...
		function init() {
			...
			$(".item_tag_name").each(function(){
				getDictItemName($(this).html(),$(this),urlAddr);
			});
			...
			//处理查询
			joinTagidsAndPlatformId("search_tagids",$("#search_item_tagids"));
			joinTagidsAndPlatformId("search_platform",$("#search_item_platform"));
			
			//处理添加
			joinTagidsAndPlatformId("add_tagids",$("#add_item_tagids"));
			joinTagidsAndPlatformId("add_platform",$("#add_item_platform"));
		...
		//将查询弹出层中的拼好的id设置到表单对应的隐藏域中
		function setTagidsAndPlatformToForm() {
		...
		function editItems(id) {
			...
			$.ajax({
				...
				success:function(data){
					...
					$("#edit_item_tagids").val(data.item_tagids);
					$("#edit_item_platform").val(data.item_platform);
					//处理checkbox状态回显
					...
					if(data.item_cap_image!=null){
						...
						$("#edit_item_cap_image_src").attr("src","/images/"+"");
					}
					//处理标志位回显
