  ...
  <div class="main">
     <div class="main-left-list">
        <div class="gutter_header">
            <a href="#">
              <img class="home_page_gutter_giftcard" src="${pageContext.request.contextPath }/image/steamcards_promo_02.png">
            </a>
            <br>
            礼物卡         
        </div><!--end-->
                    ...
                    <div class="ft-over">
                        <ul class="carousel-inner">
                          <li class="carousel-item">
                            <div class="big">
                                <a href="#"><img src="${pageContext.request.contextPath }/image/battlegrounds_616x353.jpg" /></a>
                            </div>
                            <div class="small">
                                <h3>BATTLEGROUNDS</h3>
                                <a href="#"><img src="${pageContext.request.contextPath }/image/battlegrounds01_616x353.jpg" /></a>
                                <a href="#"><img src="${pageContext.request.contextPath }/image/battlegrounds02_616x353.jpg" /></a>
                                <a href="#"><img src="${pageContext.request.contextPath }/image/battlegrounds03_616x353.jpg" /></a>
                                <a href="#"><img src="${pageContext.request.contextPath }/image/battlegrounds04_616x353.jpg" /></a>
                          ...
                          <li class="carousel-item">
                            <div class="big">
                                <img src="${pageContext.request.contextPath }/image/shadowofthtombraider_616x353.jpg" />
                            </div>
                            <div class="small">
                                <h3>FIFA 2K19</h3>
                                <img src="${pageContext.request.contextPath }/image/shadowofthtombraider01_616x353.jpg" />
                                <img src="${pageContext.request.contextPath }/image/shadowofthtombraider02_616x353.jpg" />
                                <img src="${pageContext.request.contextPath }/image/shadowofthtombraider03_616x353.jpg" />
                                <img src="${pageContext.request.contextPath }/image/shadowofthtombraider04_616x353.jpg" />
                                <div class="discount_block_left  no_discount discount_block_inline">  
                                    <div class="discount_final_price">¥ 98</div> 
                                </div>
                                <div class="platforms">
        ...
        <div class="example">
                    ...
                    <div class="ft-over ft-over2">
                        <ul class="carousel-inner">
                          <li class="carousel-item"> 
                             <a class="store_capsule broadcast_capsule app_impression_tracked"   href="#">
                                  <div class="capsule headerv5">
                                    <img src="${pageContext.request.contextPath }/image/21.jpg">
                                  </div>
                                  <div>
                              ...
                              <a class="store_capsule broadcast_capsule app_impression_tracked"   href="#">
                                  <div class="capsule headerv5">
                                    <img src="${pageContext.request.contextPath }/image/22.jpg">
                                  </div>
                                  <div>
                                    <div class="discount_block  no_discount discount_block_inline"> 
                                      <div class="discount_prices">
                              ...
                              <a class="store_capsule broadcast_capsule app_impression_tracked"   href="#">
                                  <div class="capsule headerv5">
                                    <img src="${pageContext.request.contextPath }/image/23.jpg">
                                  </div>
                                  <div>
                                    <div class="discount_block  no_discount discount_block_inline"> 
                                      <div class="discount_prices">
                              ...
                              <a class="store_capsule broadcast_capsule app_impression_tracked"   href="#">
                                  <div class="capsule headerv5">
                                    <img src="${pageContext.request.contextPath }/image/25.jpg">
                                  </div>
                                  <div>
                                    <div class="discount_block  no_discount discount_block_inline"> 
                                      <div class="discount_prices">
                          ...
                          <li class="carousel-item"> 
                              ...
                              <a class="store_capsule broadcast_capsule app_impression_tracked"   href="#">
                                  <div class="capsule headerv5">
                                    <img src="${pageContext.request.contextPath }/image/27.jpg">
                                  </div>
                                  <div>
                                    <div class="discount_block  no_discount discount_block_inline"> 
                                      <div class="discount_prices">
                              ...
                              <a class="store_capsule broadcast_capsule app_impression_tracked"   href="#">
                                  <div class="capsule headerv5">
                                    <img src="${pageContext.request.contextPath }/image/26.jpg">
                                  </div>
                                  <div>
                                    <div class="discount_block  no_discount discount_block_inline"> 
                                      <div class="discount_prices">
                              ...
                              <a class="store_capsule broadcast_capsule app_impression_tracked"   href="#">
                                  <div class="capsule headerv5">
                                    <img src="${pageContext.request.contextPath }/image/24.jpg">
                                  </div>
                                  <div>
                                    <div class="discount_block  no_discount discount_block_inline"> 
                                      <div class="discount_prices">
         ...
         <div class="button_container">
            <div class="btn_wrapper">
              <a href="javaScript:void(0)" class="big_button" onclick="sort('is_new',6)">
               	 新品          </a>
            </div>
            <div class="btn_wrapper">
              <a href="javaScript:void(0)" class="big_button" onclick="sort('is_specials',6)">
              	  特价          </a>
            </div>
            <div class="btn_wrapper">
              <a href="javaScript:void(0)" class="big_button" onclick="sort('is_free',6)">
               	免费游戏          </a>
            </div>
            <div class="btn_wrapper">
              <a href="javaScript:void(0)" class="big_button" onclick="sort('is_upcoming',6)">
               	 即将推出         </a>
            </div>
          </div><!--标签 end-->
						...
						<c:forEach items="${itemList }" var="item" begin="0" end="5">
							<a href="#" class="tab_item   app_impression_tracked">
								...
								<div class="tab_item_cap">
									<img class="tab_item_cap_img" src="/images/${item.item_cap_image }">
								</div>
        ...
        <div class="list-box list-box-sild show" id="index_list_game">
               <div id="NewReleasesTable">
                  <a href="#" class="tab_item   app_impression_tracked cur" >
                            <div class="tab_item_cap">
                              <img class="tab_item_cap_img" src="${pageContext.request.contextPath }/image/capsule_184x69 (1).jpg">
                            </div>
                            <div class="discount_block tab_item_discount no_discount"> 
                              <div class="discount_prices">
                      ...
                      <a href="#" class="tab_item   app_impression_tracked" >
                            <div class="tab_item_cap">
                              <img class="tab_item_cap_img" src="${pageContext.request.contextPath }/image/capsule_184x69 (2).jpg">
                            </div>
                            <div class="discount_block tab_item_discount no_discount"> 
                              <div class="discount_prices">
                                <div class="discount_final_price">免费开玩</div>
                      ...
                      <a href="#" class="tab_item   app_impression_tracked" >
                            <div class="tab_item_cap">
                              <img class="tab_item_cap_img" src="${pageContext.request.contextPath }/image/capsule_184x69 (3).jpg">
                            </div>
                            <div class="discount_block tab_item_discount no_discount"> 
                              <div class="discount_prices">
                                <div class="discount_final_price">免费开玩</div>
                      ...
                      <a href="#" class="tab_item   app_impression_tracked" >
                            <div class="tab_item_cap">
                              <img class="tab_item_cap_img" src="${pageContext.request.contextPath }/image/capsule_184x69 (4).jpg">
                            </div>
                            <div class="discount_block tab_item_discount no_discount"> 
                              <div class="discount_prices">
                                <div class="discount_final_price">免费开玩</div>
                      ...
                      <a href="#" class="tab_item   app_impression_tracked" >
                            <div class="tab_item_cap">
                              <img class="tab_item_cap_img" src="${pageContext.request.contextPath }/image/capsule_184x69 (5).jpg">
                            </div>
                            <div class="discount_block tab_item_discount no_discount"> 
                              <div class="discount_prices">
                                <div class="discount_final_price">免费开玩</div>
               ...
               <div class="tab_sild_box show">
                    ...
                    <div class="simg">
                      <a href="#">
                         <img src="${pageContext.request.contextPath }/image/a.jpg"/>
                      </a>
                      <a href="#">
                         <img src="${pageContext.request.contextPath }/image/a.jpg"/>
                      </a>
...
<div id="footer" class="">
    <div class="footer_content"> 
        <div class="rule"></div>
            <div id="footer_logo_steam"><img src="${pageContext.request.contextPath }/image/logo_steam_footer.png" alt="Valve Software" border="0"></div>
      
        <div id="footer_logo">
           <a href="#" target="_blank" rel="noreferrer">
               <img src="${pageContext.request.contextPath }/image/logo_valve_footer.png" alt="Valve Software" border="0">
           </a>
        </div>
        <div id="footer_text">
        ...
        <div class="valve_links">
            ...
            &nbsp; | &nbsp;
            <a href="#" target="_blank" rel="noreferrer"><img src="${pageContext.request.contextPath }/image/ico_facebook.gif"> Steam</a>
            &nbsp; | &nbsp;
            <a href="#" target="_blank" rel="noreferrer"><img src="${pageContext.request.contextPath }/image/ico_twitter.gif"> @steam_games</a>
        </div> 
    </div>
</div>
</body>
<!-- 自定义js -->
<script src="${pageContext.request.contextPath }/admin/js/steam.js"></script>
		...
		$.ajax({
			...
			success:function(data){
				...
				for(var i=0;i<data.length;i++){
					...
					//<!-- 封面图 -->
					'<div class="tab_item_cap">'+
						'<img class="tab_item_cap_img" src="/images/'+data[i].item_cap_image+'">'+
					'</div>';
						...
						'<div class="discount_block tab_item_discount no_discount">'+
							'<div class="discount_prices">';
								if(data[i].item_original_price==0){
									str += '<div class="discount_final_price">免费</div>';
								}
								if(data[i].item_original_price!=0){
					...
					if(data[i].item_discount!=0){
						...
						'<div class="discount_block tab_item_discount">'+
							...
							'<div class="discount_prices">'+
								...
								'<div class="discount_final_price">¥ '+(data[i].item_original_price * data[i].item_discount * 0.01)+'</div>'+
							'</div>'+
						'</div>';
					}
					str +=
