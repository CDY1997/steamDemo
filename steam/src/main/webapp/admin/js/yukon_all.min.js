    ...
    c = b.special.throttledresize = {
            ...
            handler: function (k, h) {
                ...
                g || (setInterval(function () {
                        e++;
                        if (e > c.threshold && f || h) k.type = "throttledresize",
                        b.dispatch.apply(l, m),
                        f = !1,
                        e = 0;
...
yukon_chat = {
    init: function () {
        if ($(".chat_message_send button").length) $(".chat_message_send button").on("click", function () {
            var a = moment().format("MMM D YYYY, h:mm A"),
                b = $(".chat_message_send textarea").val();
            "" != b && (a != $(".chat_messages").data("lastMessageUnix") && $(".chat_messages").prepend('<div class="message_date">' + a + "</div><ul></ul>").data("lastMessageUnix", a), $(".chat_messages ul:first").prepend('<li class="msg_left"><p class="msg_user">Carrol Clark</p>' + b + "</li>"), $(".chat_message_send textarea").val(""))
        })
    }
};
yukon_mailbox = {
    init: function () {
        var a = $("#mailbox_table");
        a.find(".mbox_star span").on("click", function () {
            var a = $(this),
                c = a.parent(".mbox_star");
            a.hasClass("icon_star") ? c.removeClass("marked") : c.addClass("marked");
            a.toggleClass("icon_star icon_star_alt")
        });
        $("input.msgSelect").on("click", function () {
            $(this).is(":checked") ? $(this).closest("tr").addClass("selected") : $(this).closest("tr").removeClass("selected")
        });
        a.on("click", "#msgSelectAll", function () {
            var b = $(this);
            a.find("input.msgSelect").filter(":visible").each(function () {
                b.is(":checked") ? $(this).prop("checked", !0).closest("tr").addClass("selected") : $(this).prop("checked", !1).closest("tr").removeClass("selected")
            })
        })
    }
};
    ...
    search_icons: function () {
        $("#icon_search").val("").keyup(function () {
            ...
            $(".icon_list > li > span").each(function () {
                -1 === $(this).attr("class").toLowerCase().indexOf(a) ? $(this).parent("li").hide() : $(this).parent("li").show()
            })
        })
    }
};
    ...
    search_gallery: function () {
        $("#gallery_search").val("").keyup(function () {
            ...
            $(".gallery_grid > li > a").each(function () {
                0 > $(this).text().search(new RegExp(a, "i")) && -1 === $(this).attr("title").toLowerCase().indexOf(a) ? $(this).closest("li").hide() : $(this).closest("li").show()
            })
        })
    }
};
...
yukon_2col_multiselect = {
    init: function () {
        if ($("#2col_ms_default").length) {
            ...
            a.closest(".ms-wrapper").find(".ms_select_all").click(function (b) {
                b.preventDefault();
                a.multiSelect("select_all")
            });
            a.closest(".ms-wrapper").find(".ms_deselect_all").click(function (b) {
                b.preventDefault();
                a.multiSelect("deselect_all")
            })
        }
        if ($("#2col_ms_search").length) {
            var b = $("#2col_ms_search");
            $("#2col_ms_search").multiSelect({
                ...
                afterInit: function (a) {
                    a.find(".ms-list li").each(function () {
                        var a = $(this).children("span").text(),
                            b = a.substr(2, 2),
                            c = a.substr(0, 6);
                        $(this).children("span").html('<i class="flag-' + b + '"></i>' + a.replace(c, ""))
                    });
                    var b = this;
                    a = b.$selectableUl.prev().children();
                    var e = b.$selectionUl.prev().children(),
                        f = "#" + b.$container.attr("id") + " .ms-elem-selectable:not(.ms-selected)",
                        g = "#" + b.$container.attr("id") + " .ms-elem-selection.ms-selected";
                    b.qs1 = a.quicksearch(f).on("keydown", function (a) {
                            if (40 === a.which) return b.$selectableUl.focus(),
                            !1
                        });
                    b.qs2 = e.quicksearch(g).on("keydown", function (a) {
                            if (40 == a.which) return b.$selectionUl.focus(),
                            !1
                        })
                },
            ...
            b.closest(".ms-wrapper").find(".ms_select_all").click(function (a) {
                a.preventDefault();
                b.multiSelect("select_all")
            });
            b.closest(".ms-wrapper").find(".ms_deselect_all").click(function (a) {
                a.preventDefault();
                b.multiSelect("deselect_all")
            })
        }
    }
};
yukon_ace_editor = {
    init: function () {
        var a = ace.edit("aceEditor");
        $("#aceEditor").data("editor", a);
        ...
        a.setAutoScrollEditorIntoView(!0);
        ...
        $("#editor_font_size").val("14").on("change", function () {
            document.getElementById("aceEditor").style.fontSize =
            $(this).val() + "px"
        })
    }
};
    ...
    p_plugins_calendar: function () {
        if ($("#calendar").length) {
            ...
            $("#calendar").fullCalendar({
                    ...
                    events: [{
                        title: "All Day Event",
                        start: new Date(a, c, 1)
                    },
                    {
                        title: "Long Event",
                        start: new Date(a, c, b - 5),
                        end: new Date(a, c, b - 2)
                    },
                    {
                        id: 999,
                        title: "Repeating Event",
                        start: new Date(a, c, b - 3, 16, 0)
                    },
                    {
                        id: 999,
                        title: "Repeating Event",
                        start: new Date(a, c, b + 4, 16, 0)
                    },
                    {
                        title: "Meeting",
                        start: new Date(a, c, b + 1, 19, 0),
                        end: new Date(a, c, b + 1, 22, 30)
                    },
                    {
                        title: "Lunch",
                        start: new Date(a, c, b - 7)
                    },
                    {
                        title: "Birthday Party",
                        start: new Date(a, c, b + 10)
                    },
                    {
                        title: "Click for Google",
                        url: "http://google.com/",
                        start: new Date(a, c, b + 12)
                    }],
        ...
        $("#calendar_phases").length && $("#calendar_phases").fullCalendar({
            header: {
                center: "title",
                left: "month,agendaWeek,agendaDay today",
                right: "prev,next"
            ...
            eventClick: function (a) {
                window.open(a.url, "gcalevent", "width=700,height=600");
                return !1
            },
            eventAfterAllRender: function () {
                $(".fc-header .fc-button-prev").html('<span class="el-icon-chevron-left"></span>');
...
yukon_chained_selects = {
    init: function () {
        ...
        $("#chs_engine").chained("#chs_series, #chs_model").on("change", function () {
            "" != $("option:selected", this).val() && "" != $("option:selected", $("#chs_model")).val() ? $("#chs_button").fadeIn() : $("#chs_button").hide()
        })
    }
};
yukon_charts = {
    p_dashboard: function () {
        if ($("#c3_7_days").length) {
            var a = c3.generate({
                ...
                data: {
                    x: "x",
                    columns: ["x 2013-01-01 2013-02-01 2013-03-01 2013-04-01 2013-05-01 2013-06-01 2013-07-01 2013-08-01 2013-09-01 2013-10-01 2013-11-01 2013-12-01".split(" "), ["2013", 14512, 10736, 18342, 14582, 16304, 22799, 18833, 21973, 23643, 22488, 24752, 28722],
                ...
                color: {
                    pattern: "#1f77b4 #ff7f0e #2ca02c #d62728 #9467bd #8c564b #e377c2 #7f7f7f #bcbd22 #17becf".split(" ")
                }
            });
            $(".chart_switch").on("click", function () {
                "line" == $(this).data("chart") ? (a.transform("area", "2013"), a.transform("line", "2014")) : "bar" == $(this).data("chart") && a.transform("bar");
...
yukon_gantt_chart = {
    init: function () {
        ...
        $("#ganttChart").ganttView({
            ...
            behavior: {
                onClick: function (a) {
                    a = "You clicked on an event: { start: " + a.start.toString("M/d/yyyy") + ", end: " + a.end.toString("M/d/yyyy") + " }";
                    console.log(a)
                },
                onResize: function (a) {
                    a = "You resized an event: { start: " + a.start.toString("M/d/yyyy") + ", end: " + a.end.toString("M/d/yyyy") + " }";
                    console.log(a)
                },
                onDrag: function (a) {
                    a = "You dragged an event: { start: " + a.start.toString("M/d/yyyy") + ", end: " + a.end.toString("M/d/yyyy") + " }";
                    console.log(a)
                }
            }
        })
...
yukon_clock_picker = {
    init: function () {
        $(".clockpicker").length && $(".clockpicker").clockpicker().find("input").change(function () {
...
yukon_count_up = {
    init: function () {
        $(".countUpMe").length && $(".countUpMe").each(function () {
            var a = parseInt($(this).attr("data-endVal"));
            theAnimation = new countUp(this, 0, a, 0, 2.6, {
                useEasing: !0,
                useGrouping: !0,
                separator: " "
            });
...
yukon_date_range_picker = {
    p_forms_extended: function () {
        $("#drp_time").length && $("#drp_time").daterangepicker({
            timePicker: !0,
            timePickerIncrement: 30,
            format: "MM/DD/YYYY h:mm A",
            buttonClasses: "btn btn-sm"
        });
        $("#drp_predefined").length && $("#drp_predefined").daterangepicker({
            ranges: {
                Today: [moment(), moment()],
            ...
            $("#drp_predefined span").html(a.format("MMMM D, YYYY") + " - " + b.format("MMMM D, YYYY"))
        })
    }
};
yukon_datatables = {
    p_plugins_tables_datatable: function () {
        var a = $("#datatable_demo").dataTable({
            iDisplayLength: 25
        }),
...
yukon_easyPie_chart = {
    p_dashboard: function () {
        $(".easy_chart_a").length && $(".easy_chart_a").easyPieChart({
            animate: 2E3,
            size: 90,
            lineWidth: 4,
            scaleColor: !1,
            ...
            onStep: function (a, b, c) {
                $(this.el).children(".easy_chart_percent").text(Math.round(c) + "%")
            }
        });
        $(".easy_chart_b").length && $(".easy_chart_b").easyPieChart({
            animate: 2E3,
            size: 90,
            lineWidth: 4,
            scaleColor: !1,
        ...
        $(".easy_chart_c").length && $(".easy_chart_c").easyPieChart({
            animate: 2E3,
            size: 90,
            lineWidth: 4,
            scaleColor: !1,
    ...
    p_pages_user_profile: function () {
        $(".easy_chart_user_tasks").length && $(".easy_chart_user_tasks").easyPieChart({
            animate: 2E3,
            size: 60,
            lineWidth: 3,
            scaleColor: !1,
        ...
        $(".easy_chart_user_mails").length && $(".easy_chart_user_mails").easyPieChart({
            animate: 2E3,
            size: 60,
            lineWidth: 3,
            scaleColor: !1,
            ...
            easing: "easeOutBounce",
            onStep: function (a, b, c) {
                $(this.el).children(".easy_chart_percent_text").html(Math.round(c) + "%<small>Mails</small>")
            }
        });
        $(".easy_chart_user_sale").length && $(".easy_chart_user_sale").easyPieChart({
            animate: 2E3,
            size: 60,
            lineWidth: 3,
            scaleColor: !1,
            ...
            easing: "easeOutBounce",
            onStep: function (a, b, c) {
                $(this.el).children(".easy_chart_percent").html(Math.round(c) + "%")
            }
        })
    }
};
...
yukon_gmaps = {
    init: function () {
        ...
        var a = 2 <= window.devicePixelRatio ? "&scale=2" : "",
            b = 2 <= window.devicePixelRatio ? "background-size: 640px 640px;" : "";
        ...
        $("#gmap_static").append('<span class="gmap-static" style="height:100%;display:block;background: url(' + url + a + ") no-repeat 50% 50%;" + b + '"><img src="' + url + '" style="visibility:hidden" alt="" /></span>');
        ...
        $("#geocoding_form").submit(function (a) {
                a.preventDefault();
                GMaps.geocode({
                    ...
                    callback: function (a, b) {
                        if ("OK" == b) {
                            ...
                            map_geocode.setCenter(c.lat(), c.lng());
...
yukon_magnific = {
    p_components_gallery: function () {
        $(".gallery_grid .img_wrapper").magnificPopup({
            ...
            image: {
                titleSrc: function (a) {
                    return a.el.attr("title") + "<small>" + a.el.children(".gallery_image_tags").text() + "</small>"
                }
            },
            removalDelay: 500,
            callbacks: {
...
yukon_maskedInputs = {
    p_forms_extended: function () {
        ...
        $("#mask_numeric").inputmask("\u20ac 999.999,99", {
            numericInput: !1
        });
        $("#mask_mac").inputmask({
            mask: "**:**:**:**:**:**"
        });
        $("#mask_callback").inputmask("mm/dd/yyyy", {
            placeholder: "mm/dd/yyyy",
            oncomplete: function () {
                alert("Date entered: " + $(this).val())
            }
        });
...
yukon_matchHeight = {
    p_dashboard: function () {
        $(".mHeight").each(function () {
            $(this).find(".mHeight-item").matchHeight(!0)
        });
        $(window).on("debouncedresize", function () {
...
yukon_parsley_validation = {
    ...
    p_forms_wizard: function () {
        ...
        $.listen("parsley:field:validate", function (a) {
            yukon_steps.setContentHeight("#" + a.$element.closest("div.wizard").attr("id"))
        })
    }
};
yukon_pwd_show_hide = {
    init: function () {
        $("#pwdSt_password").length && $("#pwdSt_password").hidePassword(!0)
    }
};
yukon_pwd_strength_metter = {
    init: function () {
        $("#pwdSt_password").length && $("#pwdSt_password").pwstrength({
            ui: {
...
yukon_qrcode = {
    p_pages_invoices: function () {
        $("#invoice_qrcode").css({
            width: gr_code_data.baseSize / 2,
            height: gr_code_data.baseSize / 2
        }).qrcode({
            render: "canvas",
...
yukon_rangeSlider = {
    p_forms_extended: function () {
        $("#rS_exm_1").length && $("#rS_exm_1").ionRangeSlider({
            min: 0,
            max: 5E3,
            from: 1200,
            to: 2450,
        ...
        $("#rS_exm_2").length && $("#rS_exm_2").ionRangeSlider({
            min: 1E3,
            max: 1E5,
            from: 3E4,
            to: 9E4,
        ...
        $("#rS_exm_3").length && $("#rS_exm_3").ionRangeSlider({
            min: 0,
            max: 10,
            type: "single",
            step: .1,
        ...
        $("#rS_exm_4").length && $("#rS_exm_4").ionRangeSlider({
            min: -50,
            max: 50,
            from: 0,
            postfix: "\u00b0",
        ...
        $("#rS_exm_5").length && $("#rS_exm_5").ionRangeSlider({
            min: 1E4,
            max: 1E5,
            step: 100,
            postfix: " km",
...
yukon_select2 = {
    p_forms_extended: function () {
        $("#s2_basic").length && $("#s2_basic").select2({
            allowClear: !0,
            placeholder: "Select..."
        });
        $("#s2_multi").length && $("#s2_multi").select2({
            placeholder: "Select..."
        });
        $("#s2_tokenization").length && $("#s2_tokenization").select2({
            placeholder: "Select...",
            tags: "red green blue black orange white".split(" "),
            tokenSeparators: [",", " "]
        });
        if ($("#s2_ext_value").length) {
            var a = function (a) {
                return a.id ? '<i class="flag-' + a.id + '"></i>' + a.text : a.text
            };
            ...
            $("#s2_ext_us").click(function (a) {
                a.preventDefault();
                $("#s2_ext_value").val("US").trigger("change")
            });
            $("#s2_ext_br_gb").click(function (a) {
                a.preventDefault();
                $("#s2_ext_value").val(["JP", "PL"]).trigger("change")
            })
        }
        $("#s2_load_data").length && $("#s2_load_data").select2({
            data: [{
                id: 0,
                text: "enhancement"
            },
    ...
    p_forms_validation: function () {
        $("#val_select").length && $("#val_select").select2({
            allowClear: !0,
            placeholder: "Select..."
        })
    },
    p_forms_wizard: function () {
        ...
        $("#s2_languages").length && $("#s2_languages").select2({
            placeholder: "Select language",
            tags: "Mandarin Spanish English Hindi Arabic Portuguese".split(" "),
            tokenSeparators: [",", " "]
        })
    }
};
yukon_selectize = {
    p_forms_extended: function () {
        $("#slz_optgroups").length && $("#slz_optgroups").selectize({
            sortField: "text"
        });
        $("#slz_contacts").length && $("#slz_contacts").selectize({
            persist: !1,
            maxItems: null,
            valueField: "email",
            labelField: "name",
            ...
            render: {
                item: function (a, b) {
                    var c = $.trim((a.first_name || "") + " " + (a.last_name || ""));
                    return "<div>" + (c ? '<span class="name">' + b(c) + "</span>" : "") + (a.email ? '<span class="email">' + b(a.email) + "</span>" : "") + "</div>"
                },
                option: function (a, b) {
                    var c = $.trim((a.first_name || "") + " " + (a.last_name || "")),
                        d = c ? a.email : null;
                    return '<div><span class="label">' + b(c || a.email) + "</span>" + (d ? '<span class="caption">' + b(d) + "</span>" : "") + "</div>"
                }
            },
            createFilter: function (a) {
                var b = RegExp("^([^<]*)<([a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?)>$", "i");
                return RegExp("^([a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?)$", "i").test(a) || b.test(a)
            },
            create: function (a) {
                if (RegExp("^([a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?)$", "i").test(a)) return {
                    email: a
                };
                if (a = a.match(RegExp("^([^<]*)<([a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?)>$", "i"))) {
                    var b = $.trim(a[1]),
                        c = b.indexOf(" "),
                        d = b.substring(0, c),
                        b = b.substring(c + 1);
        ...
        $("#slz_remove_btn").length && $("#slz_remove_btn").selectize({
            ...
            onDelete: function (a) {
                return confirm(1 < a.length ? "Are you sure you want to remove these " + a.length + " items?" : 'Are you sure you want to remove "' + a[0] + '"?')
            }
        })
    }
};
yukon_steps = {
    init: function () {
        $("#wizard_101").length && ($("#wizard_101").steps({
            headerTag: "h3",
            bodyTag: "section",
            ...
            onStepChanged: function (a, c, d) {
                yukon_steps.setContentHeight("#wizard_101")
            }
        }), yukon_steps.setContentHeight("#wizard_101"), $(window).on("resize", function () {
            yukon_steps.setContentHeight("#wizard_101")
        }));
        if ($("#wizard_form").length) {
            ...
            a.steps({
                ...
                onStepChanging: function (b, c, d) {
                    b = a.find(".content > .body").eq(c);
                    b.find("[data-parsley-id]").each(function () {
                        $(this).parsley().validate()
                    });
                    return b.find(".parsley-error").length ? !1 : !0
                },
                onStepChanged: function (a, c, d) {
                    yukon_steps.setContentHeight("#wizard_form")
                },
                onFinishing: function (b, c) {
                    var d = a.find(".content > .body").eq(c);
                    d.find("[data-parsley-id]").each(function () {
                        $(this).parsley().validate()
                    });
                    return d.find(".parsley-error").length ? !1 : !0
                },
                onFinished: function (a, c) {
                    alert("Submitted!")
                }
            });
            yukon_steps.setContentHeight("#wizard_form");
    ...
    setContentHeight: function (a) {
        setTimeout(function () {
            var b =
            $(a).children(".content").children(".body.current").outerHeight();
            $(a).find(".content").height(b)
        }, 0)
    }
};
yukon_switchery = {
...
yukon_textarea_autosize = {
    init: function () {
        $(".textarea_auto").length && $(".textarea_auto").autosize()
    }
};
yukon_textarea_maxlength = {
    p_forms_extended: function () {
        $("#ml_default").length && $("#ml_default").stopVerbosity({
            limit: 20,
            existingIndicator: $("#ml_default_indicator")
        });
        $("#ml_custom").length && $("#ml_custom").stopVerbosity({
            limit: 32,
            existingIndicator: $("#ml_custom_indicator"),
            indicatorPhrase: ["This is a custom indicator phrase.", "This one only counts down. Only", '<span class="label label-primary">[countdown]</span>', "characters", "left."]
        })
    }
};
yukon_typeahead = {
...
yukon_uploader = {
    p_forms_extended: function () {
        $("#uploader").length && $("#uploader").pluploadQueue({
...
yukon_vector_maps = {
    p_dashboard: function () {
        $("#world_map_vector").length && $("#world_map_vector").vectorMap({
            map: "world_mill_en",
            ...
            onRegionLabelShow: function (a, b, c) {
                "undefined" == typeof countries_data[c] ? a.preventDefault() : (a = countries_data[c], b.html(b.html() + ": " + a + " visits"))
            }
        })
    },
    p_plugins_vector_maps: function () {
        function a() {
            var a = {},
                d;
            for (d in map_ca.regions) a[d] = b[Math.floor(Math.random() * b.length)];
            return a
        }
        var b = ["#1f77b4", "#3a9add", "#888"];
        $("#updateColors").click(function (b) {
            b.preventDefault();
            map_ca.series.regions[0].setValues(a())
        });
...
yukon_wysiwg = {
    p_forms_validation: function () {
        $("#val_textarea_message").length && $("textarea#val_textarea_message").ckeditor()
    },
    p_forms_extended: function () {
        $("#wysiwg_editor").length && $("#wysiwg_editor").ckeditor()
    }
};